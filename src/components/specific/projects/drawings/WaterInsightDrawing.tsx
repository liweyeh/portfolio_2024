		...
		<div className="h-full w-full relative skew-y-[24deg] translate-x-12">
			...
			>
				<div className={`h-full w-5/6 flex flex-col items-center justify-center`}>
					<div className={`h-[50%] w-[80%] flex flex-col bg-black `}>
						<div
							className={`h-[90%] border-solid border-x-2 border-t-2 border-txt_primary rounded-t-2xl flex items-center justify-center  bg-contain ${isHovered && `bg-[url('/waterinsights.png')]`}`} // TODO: add transition
						/>
